...
const App = () => {
  const images = [
    { url: image1, title: 'O ŠÍPKOVÉ RŮŽENCE', subtitle: 'ČINOHERNÍ HUMORNÁ POHÁDKA PRO DĚTI'},
    { url: image2, title: '"Dávám ti do vínku auto a vilu."' },
    { url: image3, title: '"Tady máte ruku mou, budu Vaší Růženou."' },
    { url: image4, title: 'JAK HONZA KE ŠTĚSTÍ PŘIŠEL', subtitle:'ČINOHERNÍ VESELÁ POHÁDKA PRO DĚTI' },
    { url: image5, title: '"Když mám hlad, tak zastavím, sednu si, krávu podojím."' },
    { url: image6, title: 'SPOLU',subtitle:'ČINOHERNÍ NĚŽNÁ KOMEDIE Z MANŽELSKÉHO ŽIVOTA' },
    { url: image7, title: '"Jako bublinka vodováhy?"', subtitle:'"Základ rovnováhy."' }
  ];
//<Navbar/>
